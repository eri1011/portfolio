...
$from = "design@myportfolio-es.com";
...
$Referer_check_domain = "myportfolio-es.com";
...
$require = array('お名前','メールアドレス','件名','お問い合わせ内容');
...
//配列の形「name="○○[]"」の場合には必ず後ろの[]を取ったものを指定して下さい。
$hankaku_array = array('件名','お問い合わせ内容');
...
<meta name="description" content="齊藤江里のポートフォリオサイトです。当ページは、お問い合わせ用のフォーム(確認画面)です。">
<meta property="fb:app_id" content="5776157859142695">
<meta property="og:url" content="https://myportfolio-es.com/">
<meta property="og:title" content="TOP">
<meta property="og:site_name" content="MY PORTFOLIO">
<meta property="og:type" content="website">
<meta property="og:locale" content="ja-JP">
<meta property="og:image" content="https://myportfolio-es.com/assets/images/common/seo/ogp.jpg">
<meta property="og:description" content="お問い合わせ用のフォーム(確認画面)です。">
<meta name="twitter:card" content="summary">
<title>CONTACT(確認画面) | MY PORTFOLIO</title>
<style type="text/css">
/* 自由に編集下さい */
#formWrap {
  width: 90%;
...
<link href="/assets/images/common/seo/favicon.ico" rel="icon" type="image/x-icon">
<link rel="apple-touch-icon" href="/assets/images/common/seo/apple-touch-icon.png">
<script>
  (function(d) {
    var config = {
      kitId: 'qas8qfx',
...
<header class="header">
  <div class="wrapper">
    <div class="header__logo">
      <a href="/">
        <img class="header__logo-mark" src="/assets/images/common/main_mark.svg" alt="マーク（ヘッダーロゴ）" width="30" height="30">
        <div class="header__logo-title">MY  PORTFOLIO</div>
      </a>
    </div>
    <div class="header__opener"><span class="header__opener-span"></span><div class="header__opener-text">MENU</div></div>
  </div>
  <div class="header__nav none">
    <div class="wrapper">
      <nav class="header__nav-list">
        <ul>
          <li class="header__nav-menu"><a href="/">HOME</a></li>
					<li class="header__nav-menu"><a href="/works/">WORKS</a></li>
          <li class="header__nav-menu"><a href="/about/">ABOUT</a></li>
          <li class="header__nav-menu"><a href="/contact/">CONTACT</a></li>
        </ul>
      </nav>
      <div class="header__nav-image">
        <img class="header__nav-image--mark" src="/assets/images/common/main_mark.svg" alt="マーク" width="180" height="145">
        <div class="header__nav-image--fukidashi">
          <img class="header__nav-image--fukidashi-image" src="/assets/images/common/main_fukidashi.svg" alt="吹き出し" width="140" height="140">
          <div id ="hover_text" class="header__nav-image--fukidashi-text">
            リンクをクリック<br>
            してください。
          </div>
        </div>
...
<div class="wrapper">
  <section class="heading">
    ...
    <div class="heading__translate">連絡</div>
    <div class="heading__description">
      ポートフォリオサイトをご覧いただき<span class="br"></span>ありがとうございました。<span class="br_contact"></span>
      ご連絡は以下のフォームをご利用ください。
    </div>	
  </section>
</div>
...
<?php }else{ ?>
<h2>確認画面</h2>
<p class="center confirm__description">
...
<div class="contact-form__btn-wrapper">
  ...
  <div class="contact-form__return">
    <input class="contact-form__return-btn" type="button" value="戻る" onClick="history.back()">
  </div>
  <div class="contact-form__submit">
    <input class="contact-form__submit-btn" type="submit" value="送信する">
  </div>
</div>
</form>
<?php } ?>
...
<footer class="footer">
  <div class="footer__decoration">
    <img src="/assets/images/common/footer_decoration.svg" alt="フッター装飾画像" width="375" height="60">
  </div>
  <div class="footer__main">
    <div class="wrapper">
      <nav class="footer__main-nav">
        <div class="footer__main-nav-logo">
          <a href="/">
            <img class="footer__main-nav-logo--mark" src="/assets/images/common/main_mark.svg" alt="マーク（ヘッダーロゴ）" width="30" height="30">
            <div class="footer__main-nav-logo--title">MY  PORTFOLIO</div>
          </a>
        </div>
        <div class="footer__main-nav-link">
          <ul>
          <li><a href="/">HOME</a></li>
      ...
      <small>©2022 Saitou  Eri</small>
    </div>
    <div class="footer__main--page-top">
      <a href="#"><img src="/assets/images/common/main_page_top.svg" alt="topへ戻るボタン" width="48" height="48"></a>
    </div>
  </div>
</footer>
...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" />
<meta name="format-detection" content="telephone=no">
<meta name="description" content="齊藤江里のポートフォリオサイトです。当ページは、お問い合わせ用のフォーム(完了画面)です。">
<meta property="fb:app_id" content="5776157859142695">
<meta property="og:url" content="https://myportfolio-es.com/">
<meta property="og:title" content="TOP">
<meta property="og:site_name" content="MY PORTFOLIO">
...
<meta property="og:locale" content="ja-JP">
<meta property="og:image" content="https://myportfolio-es.com/assets/images/common/seo/ogp.jpg">
<meta property="og:description" content="お問い合わせ用のフォーム(完了画面)です。">
<meta name="twitter:card" content="summary">
<title>CONTACT(完了画面) | MY PORTFOLIO</title>
<style type="text/css">
.footer {
  padding-top: 200px;
}
...
<?php }else{ ?>
<h2>お問い合わせ 完了画面</h2>
<div class="completion__description">
  <p>
    お問い合わせありがとうございます。<br>
    メッセージの送信が完了いたしました
  </p>
  <p>
    お問い合わせいただいた内容に関しては、確認の上、<br>
    後日お返事させていただきます。 
  </p>
</div>
<div class="completion__return">
  <a class="completion__return-btn" href="<?php echo $site_top ;?>">トップへ戻る</a>
</div>
</div>
<?php copyright(); ?>
...
//確認画面無しの場合の表示、指定のページに移動する設定の場合、エラーチェックで問題が無ければ指定ページヘリダイレクト
	...
	if($empty_flag == 1){ ?>
<div class="center"><h4>入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</h4><div style="color:red"><?php echo $errm; ?></div><br /><br /><input type="button" value=" 前画面に戻る " onClick="history.back()"></div>
<?php 
...
function refererCheck($Referer_check,$Referer_check_domain){
	if($Referer_check == 1 && !empty($Referer_check_domain)){
		if(strpos($_SERVER['HTTP_REFERER'],$Referer_check_domain) === false){
			return exit('<p class="center">リファラチェックエラー。フォームページのドメインとこのファイルのドメインが一致しません</p>');
		}
	}
}
function copyright(){
